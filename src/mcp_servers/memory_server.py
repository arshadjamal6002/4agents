"""
Memory MCP server — Version 3.

Session-scoped key-value store. In-process dict for now; swap for Redis
in production without changing agent code.
"""
...
# {session_id: {key: {"value": str, "updated_at": str}}}
